...
class CmsOrder
{
    ...
    public function giveOrderListByPage()
    {
        ...
        if (request()->param('order_sn') !== '') {
            array_push($where, ['gl_order.order_sn', 'like', '%' . request()->param('order_sn') . '%']);
        }
        /*收件人*/
        if (request()->param('logistics_address_name') !== '') {
            array_push($where, ['gl_order.logistics_name', 'like', '%' . request()->param('logistics_address_name') . '%']);
        }
        /*手机号*/
        if (request()->param('logistics_address_phone') !== '') {
            array_push($where, ['gl_order.logistics_tel', 'like', '%' . request()->param('logistics_address_phone') . '%']);
        }
        /*订单状态*/
        ...
        if (request()->param('son_into_type') !== 'all') {
            array_push($where, ['gl_order.son_into_type', '=', request()->param('son_into_type')]);
